...
echo "*************************************************************************"
echo "* Get Structured Content Versions"
echo "*************************************************************************"
...
set -x
curl -s -X 'GET' "http://localhost:8080/o/headless-admin-content/v1.0//structured-contents/${structured_content_id}/versions?fields=title,version" \
  -H 'Accept-Language: en-US' \
  -u 'test@liferay.com:test' \
  | jq '.'
