...
curl -s -X 'GET' "http://localhost:8080/o/headless-delivery/v1.0/sites/${site_id}/site-pages/${page_friendly_url}/experiences?fields=experience.key,experience.name,experience.segments.name" \
