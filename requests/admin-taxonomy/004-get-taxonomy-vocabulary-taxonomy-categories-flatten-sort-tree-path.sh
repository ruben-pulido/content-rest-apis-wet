...
#curl -s -X 'GET' "http://localhost:8080/o/headless-admin-taxonomy/v1.0/taxonomy-vocabularies/${vocabulary_id}/taxonomy-categories?flatten=true&sort=dateCreated&restrictFields=actions,availableLanguages,creator,dateModified,description,externalReferenceCode,numberOfTaxonomyCategories,id,parentTaxonomyVocabulary,siteId,taxonomyCategoryProperties,taxonomyCategoryUsageCount,taxonomyVocabularyId" \
curl -s -X 'GET' "http://localhost:8080/o/headless-admin-taxonomy/v1.0/taxonomy-vocabularies/${vocabulary_id}/taxonomy-categories?flatten=true&restrictFields=actions,availableLanguages,creator,dateModified,description,externalReferenceCode,numberOfTaxonomyCategories,id,parentTaxonomyVocabulary,siteId,taxonomyCategoryProperties,taxonomyCategoryUsageCount,taxonomyVocabularyId" \
