...
echo "*************************************************************************"
echo "* Get taxonomy Vocabulary Taxonomy Categories "
echo "*************************************************************************"
...
curl -s -X 'GET' "http://localhost:8080/o/headless-admin-taxonomy/v1.0/taxonomy-vocabularies/${vocabulary_id}/taxonomy-categories?restrictFields=actions,availableLanguages,dateCreated,dateModified,description,externalReferenceCode,siteId,taxonomyCategoryProperties,taxonomyCategoryUsageCount" \
